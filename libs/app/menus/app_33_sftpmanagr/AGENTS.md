...
- Key export mails use multipart text+HTML with an in-memory ZIP attachment containing practical key filenames and a README; never place private key material directly in the message body.
